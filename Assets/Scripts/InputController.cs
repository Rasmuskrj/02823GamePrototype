...
public class InputController : MonoBehaviour {
	...
	void Update () {
        ...
        if (Input.GetAxisRaw("P2Horizontal") != 0) { p2Game.MoveX(Input.GetAxis("P2Horizontal")); if (p2x_isAxisInUse == false) { p2x_isAxisInUse = true; p2Game.MoveXRaw(Input.GetAxisRaw("P2Horizontal")); } }
        else { p2x_isAxisInUse = false; }
        if (Input.GetAxisRaw("P2Vertical") != 0) { p2Game.MoveY(Input.GetAxis("P2Vertical")); if (p2y_isAxisInUse == false) { p2y_isAxisInUse = true; p2Game.MoveYRaw(Input.GetAxisRaw("P2Vertical")); } }
        else { p2y_isAxisInUse = false; }
        if (Input.GetAxisRaw("P3Horizontal") != 0) { p3Game.MoveX(Input.GetAxis("P3Horizontal")); if (p3x_isAxisInUse == false) { p3x_isAxisInUse = true; p3Game.MoveXRaw(Input.GetAxisRaw("P3Horizontal")); } }
        else { p3x_isAxisInUse = false; }
        if (Input.GetAxisRaw("P3Vertical") != 0) { p3Game.MoveY(Input.GetAxis("P3Vertical")); if (p3y_isAxisInUse == false) { p3y_isAxisInUse = true; p3Game.MoveYRaw(Input.GetAxisRaw("P3Vertical")); } }
        else { p3y_isAxisInUse = false; }
        if (Input.GetAxisRaw("P4Horizontal") != 0) { p4Game.MoveX(Input.GetAxis("P4Horizontal")); if (p4x_isAxisInUse == false) { p4x_isAxisInUse = true; p4Game.MoveXRaw(Input.GetAxisRaw("P4Horizontal")); } }
        else { p4x_isAxisInUse = false; }
        if (Input.GetAxisRaw("P4Vertical") != 0) { p4Game.MoveY(Input.GetAxis("P4Vertical")); if (p4y_isAxisInUse == false) { p4y_isAxisInUse = true; p4Game.MoveYRaw(Input.GetAxisRaw("P4Vertical")); } }
